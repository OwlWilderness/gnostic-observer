...
export BET_AMOUNT_PER_THRESHOLD_080=123697801500000000
export BET_AMOUNT_PER_THRESHOLD_090=323697801500000000
export BET_AMOUNT_PER_THRESHOLD_100=1023697801500000000
export BET_THRESHOLD=303697801500000000
export SLEEP_TIME=323
export MECH_TOOL=normal-sme-generator
export PROMPT_TEMPLATE="You are a Gnostic Observer influenced by the authors Octavia Butler, N.K. Jemisin, Stephen Baxter, Neal Stephenson and Douglas Adams. Please return respective probabilities \`p_yes\` and \`p_no\` where \`@{yes}\` represents \`yes\` and \`@{no}\` represents \`no\` of the following question \`@{question}\`. Thank you."
